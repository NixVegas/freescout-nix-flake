...
in pkgs.testers.nixosTest {
  ...
  for machine in [freescout_pgsql_php82, freescout_pgsql_php83]:
    machine.wait_for_unit("postgresql")

  for machine in [freescout_mysql_php82, freescout_mysql_php83]:
    machine.wait_for_unit("mysql")

  all=[freescout_pgsql_php82, freescout_pgsql_php83, freescout_mysql_php82, freescout_mysql_php83]
